...
import avatar3 from './actor1.jpeg';
...
export const EditorData = () => (
  <div>
    <h3>
      Title: "Unveiling the Power of React: A Journey into Modern Web
      Development" Introduction: In the ever-evolving landscape of web
      development, React has emerged as a powerhouse, redefining the way we
      build interactive and dynamic user interfaces. Developed and maintained by
      Facebook, React has garnered immense popularity for its declarative and
      component-based approach. In this article, we'll delve into the core
      concepts of React, explore its key features, and understand why developers
      worldwide are embracing this JavaScript library. Declarative Syntax: The
      React Paradigm Shift At the heart of React lies a paradigm shift in how we
      approach building user interfaces. Unlike imperative programming, where
      developers specify each step to achieve a desired outcome, React adopts a
      declarative approach. Developers express what they want the UI to look
      like, and React takes care of the rest. This shift not only enhances code
      readability but also simplifies the process of building and maintaining
      complex UIs. Component-Based Architecture: Building Blocks of React Apps
      React's component-based architecture is a game-changer. Applications are
      divided into reusable, self-contained components, each responsible for a
      specific part of the UI. This modular structure promotes code reusability,
      maintainability, and scalability. Developers can create a rich and
      interactive user experience by composing these components like building
      blocks. Virtual DOM: Optimizing Performance One of React's key performance
      optimization techniques is the Virtual DOM. Instead of manipulating the
      entire DOM upon every state change, React creates a lightweight, in-memory
      representation of the DOM. By comparing the virtual DOM with the actual
      DOM, React efficiently updates only the necessary parts, minimizing the
      impact on performance. This results in faster rendering and a smoother
      user experience. JSX: Synergizing JavaScript and HTML JSX, or JavaScript
      XML, is a syntax extension for JavaScript recommended by React. It allows
      developers to write UI components using a syntax that closely resembles
      HTML. While it might seem unconventional at first, JSX enhances code
      readability and enables the seamless integration of JavaScript logic
      within the markup. This unique blend of JavaScript and HTML in JSX is a
      key factor in React's expressive power. 
    </h3>
  </div>
);
...
export const ordersData = [
  ...
  {
    OrderID: 845954,
    CustomerName: 'Joseph Christopher',
    TotalAmount: 87.99,
    OrderItems: 'Shoes',
    Location: 'NGA',
    Status: 'pending',
